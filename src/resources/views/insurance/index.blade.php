    ...
    <x-admin.pageheader model-name="Insurance" description="Maintain <br /> Insurance" add-button="false" class="mx-4">
        ...
        <div class="p-4 space-y-4">
            ...
            <div class="flex justify-end items-center md:px-8">
                <x-admin.generic-button data-hs-overlay="#insurance-modal">
...
<div class="md:px-8">
    <table class="w-full text-left">
        <thead class="text-xs">
            <tr class=" bg-gray-200 dark:border-secondary-900 dark:bg-secondary-900
        ...
        <tbody class="text-gray-600 dark:text-gray-100 text-sm">
            <tr>
                ...
                <td
                    class="sm:p-3 py-2 px-1 border-b border-gray-200 dark:border-gray-800 md:table-cell max-w-[20px] hidden ">
